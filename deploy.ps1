# deploy.ps1 — 部署 product-dv-report-review skill 到用户级技能目录
...
$dst = Join-Path $env:USERPROFILE '.agents\skills\product-dv-report-review'
...
Write-Host "验证：在 copilot 或 opencode 中问『你有哪些可用的 skill』，应出现 product-dv-report-review"
