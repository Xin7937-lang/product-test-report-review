---
name: battery-dv-report-review
description: 审核电池包DV（设计验证）测试报告与试验汇报（Word .docx / PPT .pptx），检查文档合规性、数据逻辑一致性、试验项目覆盖度，输出带证据引用的分级审核发现；支持单份审核与文件夹批量审核。当用户提供DV测试报告、试验报告、型式试验报告、测试总结或汇报PPT，并要求审核、检查、评审、review、把关时使用。
---
